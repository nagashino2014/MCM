...
export function RuleEditModal({ rule, extractionRange, onSave, onDelete, onClose }: Props) {
  ...
  return (
    <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && onClose()}>
      <div className="glass-panel rounded-3xl w-[560px] max-w-[92vw] p-6 flex flex-col gap-5 max-h-[88vh] overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          <Field label="페이지 범위">
            <div className="flex items-center gap-2">
              ...
              />
              <span className="text-[11px] text-stone-400 font-medium">페이지</span>
          ...
          <div className="flex items-center justify-between bg-white/40 border border-white/60 rounded-xl px-4 py-3">
            <div>
              <div className="text-xs font-bold text-stone-700">필수 항목</div>
        ...
        <div className="flex items-center justify-between pt-2 border-t border-stone-200/70">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <button
              type="button"
              className="rounded-xl px-4 py-2 text-sm font-bold text-white bg-primary hover:bg-primary/90 shadow-sm"
              onClick={handleSave}
            >
              저장
            </button>

...
import { deleteSignalWithFeedback, getIntelSignalDetail, linkSignalFacility, updateSignalStatus } from "@/lib/intel/intel-queries";
import { isFeedbackReason } from "@/lib/intel/intel-feedback";
...
/** 개별 삭제 — 사유(reason) 필수. 사유·스냅샷은 intel_signal_feedback 에 남고 재수집이 차단된다. */

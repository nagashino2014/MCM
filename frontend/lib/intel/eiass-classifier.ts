...
function buildPrompt(input: {
  ...
  return (
    ...
    '"confidence": "high|medium|low", "summary": "한국어 한 줄 요약"}'
  );
}
...
function normalize(j: Record<string, unknown>): EiassClassification {
 ...
 */
export async function classifyEiass(input: Parameters<typeof buildPrompt>[0]): Promise<EiassClassification | null> {

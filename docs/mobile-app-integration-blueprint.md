...
| **M2 전자결재** ✅배포완료 | 결재함·상세·승인/반려·AI요약 (기안·문서함은 미포함) | 실기기에서 대기 문서 승인·반려 완주, 웹에 즉시 반영 → **실기기 검증 대기** |
...
| **M5 근태·휴가** | 내 근태·내 휴가·휴가 신청(결재 연동)·연차촉진 서명 (+체크인 채택 시) | 휴가 신청→결재 승인→잔여 반영 완주 |
